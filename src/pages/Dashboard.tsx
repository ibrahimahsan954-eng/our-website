  ...
  return (
    <main className="min-h-screen bg-background px-6 py-10 text-foreground">
      <div className="mx-auto flex w-full max-w-4xl flex-col gap-8">
        <header className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex items-center gap-3">
            <Button
              asChild
              variant="outline"
              className="gap-2 rounded-full border border-white/10 bg-white/5 text-white transition-colors hover:bg-white/10 hover:text-white"
            >
              <a href="/">
                View site
        ...
        <section className="flex flex-col gap-4 rounded-2xl border border-white/10 bg-[#080808] p-5">
          ...
          <div className="flex flex-col gap-3">
            {mediaSlots.map(({ slot, label }) => {
              ...
              return (
                <div
                  key={slot}
                  className="rounded-2xl border border-white/10 bg-[#080808] p-4"
                >
        ...
        {inquiries === null ? (
          <div className="flex flex-col items-center gap-4 rounded-2xl border border-white/10 bg-[#080808] px-6 py-16 text-center">
          ...
          <ul className="flex flex-col gap-3">
            {list.map((inquiry) => {
              ...
              <li
                key={inquiry._id}
                className={cn(
                  "rounded-2xl border bg-[#080808] p-5 transition-all duration-300",
                  unread
